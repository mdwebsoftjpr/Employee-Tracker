          ...
          SingleChildScrollView(
           ...
           child:Column(
            children: [
             ...
             Row(
              children: [
                Expanded(child: Text('Role Of This company:',style: TextStyle(fontSize: 6 * MediaQuery.of(context).devicePixelRatio),),),
            ...
            Row(
              children: [
                ...
                Expanded(child: Expanded(child: Text('${userdata!['trade_name']}',style: TextStyle(fontSize: 6 * MediaQuery.of(context).devicePixelRatio),),),)
              ],
            ),
            Row(
              children: [
            ...
            Row(
              children: [
                Expanded(child: Text('Pan Card No. : ',style: TextStyle(fontSize: 6 * MediaQuery.of(context).devicePixelRatio),),),
            ...
            Row(
              children: [
                Expanded(child: Text('Website Name: ',style: TextStyle(fontSize: 6 * MediaQuery.of(context).devicePixelRatio),),),
                Expanded(child: Expanded(child: Text('${userdata!['website_link']}',style: TextStyle(fontSize: 6 * MediaQuery.of(context).devicePixelRatio),),),)
              ],
            ),
            ],
           )
